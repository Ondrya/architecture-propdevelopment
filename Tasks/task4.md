...
2. **Определите все роли и их полномочия при работе с Kubernetes.** Мы подготовили [шаблон таблицы](../files/Шаблон_проектная_работа_5спринт.md). Заполните её: укажите там роли, их полномочия и группы пользователей, которые им соответствуют.
